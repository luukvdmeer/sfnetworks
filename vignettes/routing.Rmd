...
paths_sf = as_sfnetwork(roxel) %>% 
  ...
  sf::st_as_sf()
table(paths_sf$type)
plot(roxel["type"], lwd = 5, reset = FALSE)
...
For the puroposes of illustration, lets imagine we're routing for a vehicle that we want to keep away from residential roads, and which have much lower costs per unit distance on secondary roads:
