...
plot(st_nearest_points(pois[1, ], net)[nearest_nodes[1]], col = "grey", lty = 2, lwd = 2, add = TRUE)
plot(st_nearest_points(pois[2, ], net)[nearest_nodes[2]], col = "grey", lty = 2, lwd = 2, add = TRUE)
plot(net, cex = 2, lwd = 4)
...
plot(net, cex = 2, lwd = 4)
plot(pois, pch = 8, cex = 2, lwd = 2, add = TRUE)
plot(st_nearest_points(pois[1, ], activate(net, "edges")), col = "grey", lty = 2, lwd = 2, add = TRUE)
plot(st_nearest_points(pois[2, ], activate(net, "edges")), col = "grey", lty = 2, lwd = 2, add = TRUE)
