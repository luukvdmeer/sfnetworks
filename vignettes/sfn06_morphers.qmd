---
title: "Spatial morphers"
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{6. Spatial morphers}
...
<!-- plot(st_geometry(new_net, "edges")) -->
<!-- plot(st_as_sf(new_net)["louvain"], key.pos = NULL, pch = 20, add = TRUE) -->
<!-- plot(st_geometry(contracted_net, "edges")) -->
<!-- plot( -->
...
<!-- plot(net) -->
<!-- plot(net, col = "red", cex = 0.8, lwd = 0.1) -->
