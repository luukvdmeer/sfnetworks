...
Rounding of coordinates can invalidate geometries within your set of lines and cause problems later. We can test whether each line is valid. E.g.:

```{r}
edges %>%
  mutate(valid = purrr::map_lgl(x, st_is_valid)) %>%
  filter(valid == FALSE)
```
